<article style="" class="brand">
	<div class="container">
		<div class="d-flex flex-wrap align-items-center">
			<div class="ve-chung-toi-img <?= $deviceType == 'computer' ? 'w-50' : 'w-100' ?>" data-aos="fade-right">
				<img src="<?=_upload_hinhanh_l . $vechungtoi['photo']?>" alt="<?=$vechungtoi['ten']?>" class="img-fluid img-100">
			</div>
			<div class="ve-chung-toi <?= $deviceType == 'computer' ? 'w-50' : 'w-100' ?>" data-aos="fade-left">
		...
		<div class="wrap-about2">
			...
			<?php if ($deviceType == 'computer') { ?>
				...
				<div class="d-flex justify-content-between bgcolor1 text-color2" data-aos="fade-up">
					<?php foreach($vechungtoi2 as $k => $v) { ?>
			...
			<?php } else { ?>
				<div class="d-grid custom" data-aos="fade-up">
					<?php foreach($vechungtoi2 as $k => $v) { ?>
						<div>
							<div class="wrap-about2-images">
								<img src="<?=_upload_tintuc_l.$v["photo"]?>" alt="<?=$v["ten"]?>" class="img-fluid img-100">
...
<article class="product">
	<div class="container">
		...
		<div class="d-grid-3 custom" data-aos="fade-up">
				...
				<div class="product-box">
					...
					<div class="sp-info text-left">
						...
						<div class="sp-prices d-flex justify-content-between align-items-center flex-wrap">
							<div class="box-price text-color2 d-flex justify-content-between w-200 align-items-center">
								<?php if ($v['giakm']>0) { ?>
	...
	<div class="slick-banner">
		<?php foreach($hvdg as $k => $v) {?>
			<div class="ve-chung-toi d-flex justify-content-between align-items-center flex-wrap">
				<h3 class="mb-3 brand-title w-30"><?=$v['ten']?></h3>
				<div class="w-30">
					<img src="<?=_upload_tintuc_l . $v['photo']?>" alt="<?=$v['ten']?>" class="img-fluid img-100 cook-img">
				</div>
				<div class="mb-3 w-40 text-color fw-b"><?=$v['mota']?></div>
			</div>
		<?php } ?>
	</div>
...
<article class="home-product custom pb-5">
	<div class="container">
		...
		<div class="slick-product2" data-aos="fade-up">
			...
			<div class="">
				...
				<div class="">
					...
					<img src="<?=thumb($v["photo"],_upload_tintuc_l,$v["tenkhongdau"],400,400,2,80)?>" alt="<?=$v["ten"]?>" class="img-fluid img-100">
				</div>
				<div class="slick-product-space"></div>
			</div>
			<?php } ?>
...
<article class="video-khoa-hoc">
	<div class="container">
		...
		<div class="video-kh-gt-image an-pc pb-2" data-aos="fade-up">
			<img src="<?=_upload_hinhanh_l . $videokh['photo']?>" alt="<?=$videokh['ten']?>" class="img-fluid img-100 cook-img">
		</div>
		<div class="d-grid-3 custom">
			<div class="video-kh-gt-image hide-sm" data-aos="fade-up">
				<img src="<?=_upload_hinhanh_l . $videokh['photo']?>" alt="<?=$videokh['ten']?>" class="img-fluid img-100 cook-img">
			</div>
	...
	<div class="container">
		<div class="bsa-dev-contain" >
			...
			<div class="d-flex justify-content-between align-items-end flex-wrap">
				<div class="w-40" data-aos="fade-right"><a href="<?=$bdht['video']?>" class="cook-more bgcolor1 text-color2 fw-b">Xem chi tiết</a></div>
				<div class="bsa-desc text-center w-60" data-aos="fade-left">
					<a href="<?=$bdht['video']?>"><img src="<?=_upload_hinhanh_l . $bdht['photo']?>" alt="<?=$bdht['ten']?>" class="img-fluid img-100 cook-img"></a>
				</div>
