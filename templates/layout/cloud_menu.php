<!-- layout menu mobile left side bar -->
<div id="edu-mobile-menu-layout" class="edu-mobile-menu-layout">
    <div class="edu-mobile-menu-layout-head">
        <img src="<?=_upload_hinhanh_l.$row_photo['logo']?>" alt="logo" class="img-fluid edu-mobile-logo-layout">
...
<!-- END layout menu mobile left side bar END -->