		...
		<div class="box_login_acoun">
			...
			<div class="content">
						<form role="form" action="" method="post" enctype="multipart/form-data" name="formdktv" id="formdktv" onsubmit="return check();">
							<div class="form-group row mb-2 clear">
							...
							</div><div class="form-group row mb-2 clear">
						...
						<div class="modal-footer">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
								...
								<button type="button" class="btn btn-primary bgcolor1" onclick="return check();">Đăng ký</button>
							</div>
						</div>
				</div>
				<div class="clear"></div>
