			...
			<div class="content">
				<form role="form" action="" method="post" enctype="multipart/form-data" name="formdoipass" id="formdoipass">
					<div class="form-group clear">
						<div class="row">
							<label for="recipient-name" class="col-sm-3 col-12 control-label">Mật khẩu cũ</label>
					...
					<div class="form-group clear">
						<div class="row">
							<label for="recipient-name" class="col-sm-3 col-12 control-label">Mật khẩu mới</label>
							<div class="col-sm-9 col-12">
					...
					<div class="form-group clear">
						<div class="row">
							<label for="recipient-name" class="col-sm-3 col-12 control-label">Gõ lại mật khẩu mới</label>
							<div class="col-sm-9 col-12">
