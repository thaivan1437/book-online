<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=AIzaSyB2sl3FBhhDw2JFbKXBQkl2qQP9bzr_FVA&#038;ver=4.9.8"
...
<form name="supplier" id="validate" class="form" action="default.php?com=setting&act=save&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">	
    ...
    <div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" value='<?=@$item['map']?>' name="map" title="Nhập mã nhúng bản đồ" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
    ...
    <div class="widget">
        ...
        <div class="formRow">
			...
			<div class="formRight">
				...
				<input type="text" value="<?=@$item['hotline1']?>" name="hotline1" title="Nhập hotline 2" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
    ...
    <div class="widget">
		...
		<div class="formRow">
			<label>Google console (Google Web Mastertool)</label>
			<div class="formRight">
