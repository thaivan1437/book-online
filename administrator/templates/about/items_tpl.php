  ...
  <div class="titlee" style="padding-bottom:5px;">
    <div class="timkiem" >
		<form name="search" action="" method="GET" class="form giohang_ser">
		  <input name="com" value="about" type="hidden"  />
...
<div class="control_frm" style="margin-top:0;">
  	<div style="float:left;">
        ...
        <input type="button" class="blueB" value="Xoá nhiều" onclick="ChangeAction('default.php?com=about&act=man&type=<?=$_REQUEST["type"]?>&multi=del');return false;" />
    </div>
