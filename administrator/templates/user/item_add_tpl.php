...
<form name="supplier" id="validate" class="form" action="default.php?com=user&act=save" method="post" enctype="multipart/form-data">	        
    <div class="widget">
        ...
        <div class="formRow">
			...
			<div class="formRight">
				<select name="role" title="Chọn nhóm quản trị">
					<option value="3" <?php if($item['role']==3) echo "selected"; ?> >Administrator</option>
					<option value="1" <?php if($item['role']==1) echo "selected"; ?> >User</option>
				</select>
			</div>
			<div class="clear"></div>
		</div>
