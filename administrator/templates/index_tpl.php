...
$(function () {
    $('#container').highcharts({
        ...
        subtitle: {
            text: 'Devetloper by : <a href="">Anonymous</a>'
        },
        xAxis: {
            type: 'category',
            labels: {
...
<div class="widget">
   <div class="title"><h6>Chào mừng bạn đến với Administrator - HỆ THỐNG QUẢN TRỊ NỘI DUNG WEBSITE - Powered by <a href="" target="_blank"><span style="color:#f00;">Anonymous</span></a></h6><div class="clear"></div></div>
