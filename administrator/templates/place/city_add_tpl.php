...
<form name="supplier" id="validate" class="form" action="default.php?com=place&act=save_city&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
                <input type="text" name="phiship" title="Nhập phí ship cho tỉnh thành" id="name" class="tipS validate[required]" value="<?=@$item['phiship']?>" />
			</div>
			<div class="clear"></div>
		</div>	
