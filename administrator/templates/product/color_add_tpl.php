...
<form name="supplier" id="validate" class="form" action="default.php?com=product&act=save_color&idc=<?= $_REQUEST['idc'] ?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div id="info" class="tab_content">
            ...
            <div class="formRow">
				<label>Mã màu</label>
				<div class="formRight">
					<input style="width:300px" type="text" name="color" title="Nhập mã màu" id="color" class="tipS" value="<?=@$item['color']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
