            ...
            <ul>
				...
				<li class="ddnew">
					...
					<ul class="userMessage">
						...
						<li><a href="default.php?com=contact&act=man" title="" class="sInbox"><span>Liên hệ</span> <span class="numberTop" style="float:none; display:inline-block"> <?=$row_lienhe['num']?> </span></a></li>
					</ul>
				</li>
